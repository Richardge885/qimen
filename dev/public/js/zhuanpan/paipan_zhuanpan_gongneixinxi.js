function zhuanpan_info(info, paifa) {
  ...
  async function getCurrentGongweiInfo(gongweiIndex) {
    ...
    const angan = document.querySelectorAll('[data-anganzhi]')[gongweiIndex].innerHTML.charAt(0);
    let bagua = '';
    switch (gongweiIndex) {
      case 0:
        bagua = '坎';
  ...
  function updateGejuInfo(
    ...
    result = result + getJiGe(tianpangan, dipangan, xing, men, tianpanshen, gongwei);
    return result;
  }
  function whichGeJu(tianpangan, dipangan) {
    ...
    switch (group) {
      ...
      case '乙丁':
        output =
          output + '<span style="color:#0079FE">奇仪相佐：</span>最利文书、考试，百事可为。<br>';
        break;
      case '乙戊':
        output =
          output +
        ...
        break;
      case '乙己':
        output = output + '<span style="color:#0079FE">日奇入墓：</span>被土暗昧、门凶事必凶。<br>';
        break;
      case '乙庚':
        output = output + '<span style="color:#0079FE">日奇被刑：</span>有争讼，各怀私意。<br>';
        break;
      case '乙辛':
        output =
          output +
      ...
      case '丙乙':
        output = output + '<span style="color:#0079FE">日月并行：</span>公谋私为皆为吉。<br>';
        break;
      case '丙丙':
        output = output + '<span style="color:#0079FE">月奇悖师：</span>文书逼迫，破耗遗失。<br>';
        break;
      case '丙丁':
        output =
          output + '<span style="color:#0079FE">星奇朱雀：</span>贵人文书吉利，常人平静安乐。<br>';
        break;
      case '丙戊':
        output =
          output +
      ...
      case '丙庚':
        ...
        break;
      case '丙辛':
        output = output + '<span style="color:#0079FE">日月相会：</span>谋事成就，病人不凶。<br>';
        break;
      case '丙壬':
        output = output + '<span style="color:#0079FE">火入天罗：</span>为客不利，是非颇多。<br>';
        break;
      case '丙癸':
        output =
          output +
      ...
      case '丁戊':
        ...
        break;
      case '丁己':
        output = output + '<span style="color:#0079FE">火入勾陈：</span>奸私仇怨，事因女人。<br>';
        break;
      case '丁庚':
        output = output + '<span style="color:#0079FE">星奇受阻：</span>文书阻隔，行人必归。<br>';
        break;
      case '丁辛':
        output = output + '<span style="color:#0079FE">朱雀入狱：</span>罪人失囚，官人失位。<br>';
        break;
      case '丁壬':
        output = output + '<span style="color:#0079FE">奇仪相合：</span>贵人恩诏，诉狱公平。<br>';
        break;
      case '丁癸':
        output =
          output +
      ...
      case '戊乙':
        output = output + '<span style="color:#0079FE">青龙和会：</span>门吉事吉，门凶事也凶。<br>';
        break;
      case '戊丙':
        output =
          output +
      ...
      case '戊戊':
        output =
          output + '<span style="color:#0079FE">伏吟：</span>凡事不利，道路闭塞，以守为好。<br>';
        break;
      case '戊己':
      ...
      case '戊辛':
        ...
        break;
      case '戊壬':
        output = output + '<span style="color:#0079FE">青龙入天牢：</span>凡阴阳事皆不吉利。<br>';
        break;
      case '戊癸':
        output =
          output +
      ...
      case '己丙':
        output =
          output + '<span style="color:#0079FE">火悖地户：</span>男人冤冤相害；女人必致淫污。<br>';
        break;
      case '己丁':
        output = output + '<span style="color:#0079FE">朱雀入狱：</span>文书词讼，先曲后直<br>';
        break;
      case '己戊':
        output =
          output +
      ...
      case '己庚':
        ...
        break;
      case '己辛':
        output = output + '<span style="color:#0079FE">游魂入墓：</span>易招阴邪鬼魅作祟。<br>';
        break;
      case '己壬':
        output =
          output +
      ...
      case '庚乙':
        output = output + '<span style="color:#0079FE">太白逢星：</span>退吉进凶，谋为不利。<br>';
        break;
      case '庚丙':
        output =
          output + '<span style="color:#0079FE">太白入荧：</span>贼必来，为客进利，为主破财。<br>';
        break;
      case '庚丁':
        output =
          output +
        ...
        break;
      case '庚戊':
        output = output + '<span style="color:#0079FE">天乙伏宫：</span>百事不可谋，大凶。<br>';
        break;
      case '庚己':
        output =
          output +
      ...
      case '辛辛':
        output =
          output + '<span style="color:#0079FE">伏吟天庭：</span>公废私就，讼狱自羅罪名。<br>';
        break;
      case '辛壬':
        output =
          output +
      ...
      case '壬乙':
        output = output + '<span style="color:#0079FE">小蛇得势：</span>女人柔顺，男人通达。<br>';
        break;
      case '壬丙':
        output = output + '<span style="color:#0079FE">水蛇入火：</span>两败俱伤，为客不利。<br>';
        break;
      case '壬丁':
        output =
          output +
      ...
      case '壬庚':
        ...
        break;
      case '壬辛':
        output = output + '<span style="color:#0079FE">腾蛇相缠：</span>纵得吉门，亦不能安。<br>';
        break;
      case '壬壬':
        output =
          output +
      ...
      case '癸乙':
        output = output + '<span style="color:#0079FE">华盖逢星：</span>贵人禄位，常人平安。<br>';
        break;
      case '癸丙':
        output =
          output + '<span style="color:#0079FE">华盖悖师：</span>贵贱逢之皆不利，唯上人见喜。<br>';
        break;
      case '癸丁':
        output =
          output +
      ...
      case '癸己':
        ...
        break;
      case '癸庚':
        output = output + '<span style="color:#0079FE">太白入网：</span>以暴力争讼，自邏罪责。<br>';
        break;
      case '癸辛':
        output = output + '<span style="color:#0079FE">网盖天牢：</span>官司败诉，死罪难逃。<br>';
        break;
      case '癸壬':
        output =
          output +
        ...
        break;
      case '癸癸':
        output = output + '<span style="color:#0079FE">天网四张：</span>主行人失伴，病讼皆伤。<br>';
        break;
    }
    return output;
  }
  ...
  function getJiGe(tianpangan, dipangan, xing, men, shen, gongwei) {
    ...
    let result = '<br><hr><br>';
    const tianpanjigong = document.querySelectorAll('[data-tianpanyikong]')[whichGong].innerText;
      ...
      if (men == '杜门') {
        if (shen == '九地') {
          if (dipangan == '己' || dipanjigong == '己') {
            result =
              result + '<span style="color:#0079FE">地假：</span>宜藏伏，逃难，侦查。<br><br>';
          }
        }
      }
    }
    ...
    if (tianpangan == '丁' || tianpanjigong == '丁') {
      if (men == '杜门') {
        if (shen == '太阴') {
          if (dipangan == '己' || dipanjigong == '己') {
            result =
              result + '<span style="color:#0079FE">物假：</span>宜埋葬，伏藏，交易。<br><br>';
          }
        }
      }
    }
    ...
    if (tianpangan == '丙' || tianpanjigong == '丙') {
      if (men == '生门') {
        if (shen == '九天') {
          result =
            result + '<span style="color:#0079FE">神遁：</span>大利功名，开创，宣扬等事。<br><br>';
        }
      }
    }
    // 鬼遁
    ...
    if (
      ...
      if (tianpangan == '乙' || tianpanjigong == '乙' || dipangan == '乙' || dipanjigong == '乙') {
        if (gongwei == '乾')
          result =
            result +
    ...
    if (tianpangan == '庚' || tianpanjigong == '庚') {
      ...
      } else if (dipangan == yuegan || dipanjigong == yuegan) {
        result =
          result +
      ...
      } else if (dipangan == rigan || dipanjigong == rigan) {
        result =
          result +
      ...
      } else if (dipangan == shigan || dipanjigong == shigan) {
        result =
          result +
