export function feipan_info(info) {
  ...
  function getZhengGe(tianpangan, dipangan) {
    ...
    switch (group) {
      ...
      case '丁丙':
        output =
          output + tuiruge + '<br>' + '<span style="color:#0079FE">玉女游月：</span>宜缓缓施为，贵人扶持，受恩诏。<br>';
        break;
      case '丁丁':
        output =
          output +
      ...
      case '己甲':
        output = output + xiahege + neiqinge + '<span style="color:#0079FE">合土格：</span>主宜农业田士耕种等事。<br>';
        break;
      case '己乙':
        output =
          output +
      ...
      case '己戊':
        output =
          output + tuiruge + '<br>' + '<span style="color:#0079FE">比和安通：</span>明事不宜暗事宜，主男女私情。<br>';
        break;
      case '己己':
        output =
          output +
      ...
      case '庚辛':
        output =
          output + jinruge + '<br>' + '<span style="color:#0079FE">太白束虎：</span>正义战胜邪恶，但远行车折马死。<br>';
        break;
      case '庚壬':
        output =
          output +
  ...
  function getFuGe(tianpangan, dipangan, gong) {
    ...
    if ((tianpangan == '甲' && dipangan == '乙') || (dipangan == '甲' && tianpangan == '乙')) {
      switch (gong) {
        case '乾':
          result = result + lifa + '<br>' + '<span style="color:#0079FE">摧残格：</span>' + cuican + '<br>';
          break;
        case '兑':
          result = result + lifa + '<br>' + '<span style="color:#0079FE">摧残格：</span>' + cuican;
          break;
        case '坎':
          result = result + taixi + '<br>' + '<span style="color:#0079FE">得力格：</span>' + deli;
          break;
        case '离':
          result = result + fenlin + '<br>' + '<span style="color:#0079FE">破精格：</span>' + pojing;
          break;
        case '震':
          result = result + quzhi + '<br>' + '<span style="color:#0079FE">结党格：</span>' + jiedang;
          break;
        case '巽':
          result = result + quzhi + '<br>' + '<span style="color:#0079FE">结党格：</span>' + jiedang;
          break;
        case '坤':
          result = result + xingchuang + '<br>' + '<span style="color:#0079FE">失利格：</span>' + shili;
          break;
        case '艮':
          result = result + xingchuang + '<br>' + '<span style="color:#0079FE">失利格：</span>' + shili;
          break;
    ...
    } else if ((tianpangan == '丙' && dipangan == '丁') || (dipangan == '丙' && tianpangan == '丁')) {
      switch (gong) {
        case '乾':
          result = result + douli + '<br>' + '<span style="color:#0079FE">失利格：</span>' + shili;
          break;
        case '兑':
          result = result + douli + '<br>' + '<span style="color:#0079FE">失利格：</span>' + shili;
        case '坎':
          result = result + yanmu + '<br>' + '<span style="color:#0079FE">摧残格：</span>' + cuican;
          break;
        case '离':
          result = result + yanshang + '<br>' + '<span style="color:#0079FE">结党格：</span>' + jiedang;
          break;
        case '震':
          result = result + zenghui + '<br>' + '<span style="color:#0079FE">得力格：</span>' + deli;
          break;
        case '巽':
          result = result + zenghui + '<br>' + '<span style="color:#0079FE">得力格：</span>' + deli;
          break;
        case '坤':
          result = result + shiguang + '<br>' + '<span style="color:#0079FE">破精格：</span>' + pojing;
          break;
        case '艮':
          result = result + shiguang + '<br>' + '<span style="color:#0079FE">破精格：</span>' + pojing;
          break;
    ...
    } else if ((tianpangan == '戊' && dipangan == '己') || (dipangan == '戊' && tianpangan == '己')) {
      switch (gong) {
        case '乾':
          result = result + juejing + '<br>' + '<span style="color:#0079FE">破精格：</span>' + pojing;
          break;
        case '兑':
          result = result + juejing + '<br>' + '<span style="color:#0079FE">破精格：</span>' + pojing;
          break;
        case '坎':
          result = result + poshui + '<br>' + '<span style="color:#0079FE">失利格：</span>' + shili;
          break;
        case '离':
          result = result + bianxiang + '<br>' + '<span style="color:#0079FE">得力格：</span>' + deli;
          break;
        case '震':
          result = result + huaiti + '<br>' + '<span style="color:#0079FE">摧残格：</span>' + cuican;
          break;
        case '巽':
          result = result + huaiti + '<br>' + '<span style="color:#0079FE">摧残格：</span>' + cuican;
          break;
        case '坤':
          result = result + jiase + '<br>' + '<span style="color:#0079FE">结党格：</span>' + jiedang;
          break;
        case '艮':
          result = result + jiase + '<br>' + '<span style="color:#0079FE">结党格：</span>' + jiedang;
          break;
    ...
    } else if ((tianpangan == '庚' && dipangan == '辛') || (dipangan == '庚' && tianpangan == '辛')) {
      switch (gong) {
        case '乾':
          result = result + congge + '<br>' + '<span style="color:#0079FE">结党格：</span>' + jiedang;
          break;
        case '兑':
          result = result + congge + '<br>' + '<span style="color:#0079FE">结党格：</span>' + jiedang;
          break;
        case '坎':
          result = result + xiejin + '<br>' + '<span style="color:#0079FE">破精格：</span>' + pojing;
          break;
        case '离':
          result = result + bikou + '<br>' + '<span style="color:#0079FE">摧残格：</span>' + cuican;
          break;
        case '震':
          result = result + fegnren + '<br>' + '<span style="color:#0079FE">失利格：</span>' + shili;
          break;
        case '巽':
          result = result + fegnren + '<br>' + '<span style="color:#0079FE">失利格：</span>' + shili;
          break;
        case '坤':
          result = result + yangwei + '<br>' + '<span style="color:#0079FE">得力格：</span>' + deli;
          break;
        case '艮':
          result = result + yangwei + '<br>' + '<span style="color:#0079FE">得力格：</span>' + deli;
          break;
    ...
    } else if ((tianpangan == '壬' && dipangan == '癸') || (dipangan == '壬' && tianpangan == '癸')) {
      switch (gong) {
        case '乾':
          result = result + tongguan + '<br>' + '<span style="color:#0079FE">得力格：</span>' + deli;
          break;
        case '兑':
          result = result + tongguan + '<br>' + '<span style="color:#0079FE">得力格：</span>' + deli;
          break;
        case '坎':
          result = result + runxia + '<br>' + '<span style="color:#0079FE">结党格：</span>' + jiedang;
          break;
        case '离':
          result = result + mierun + '<br>' + '<span style="color:#0079FE">失利格：</span>' + shili;
          break;
        case '震':
          result = result + baiyuan + '<br>' + '<span style="color:#0079FE">破精格：</span>' + pojing;
          break;
        case '巽':
          result = result + baiyuan + '<br>' + '<span style="color:#0079FE">破精格：</span>' + pojing;
          break;
        case '坤':
          result = result + jueji + '<br>' + '<span style="color:#0079FE">摧残格：</span>' + cuican;
          break;
        case '艮':
          result = result + jueji + '<br>' + '<span style="color:#0079FE">摧残格：</span>' + cuican;
          break;
  ...
  function getZhangSheng(tiangan, gongwei) {
    ...
    switch (tiangan) {
      ...
      case '乙':
        switch (gongwei) {
          ...
          case '坎':
            ...
            break;
          case '艮':
            result = '乙' + getLiuQin('乙', originalGongWei) + '：' + diwang + '，' + shuai + '  ' + '（仲甲）';
            break;
          case '震':
            result = '乙' + getLiuQin('乙', originalGongWei) + '：' + linguan + '  ' + '（仲甲）';
            break;
          case '巽':
            result = '乙' + getLiuQin('乙', originalGongWei) + '：' + muyu + '，' + guandai + '  ' + '（仲甲）';
            break;
          case '离':
      ...
      case '丙':
        switch (gongwei) {
          ...
          case '坎':
            ...
            break;
          case '艮':
            result = '丙' + getLiuQin('丙', originalGongWei) + '：' + yang + '，' + zhangsheng + '  ' + '（孟甲）';
            break;
          case '震':
            result = '丙' + getLiuQin('丙', originalGongWei) + '：' + muyu + '  ' + '（孟甲）';
            break;
          case '巽':
            result = '丙' + getLiuQin('丙', originalGongWei) + '：' + guandai + '，' + linguan + '  ' + '（孟甲）';
            break;
          case '离':
            result = '丙' + getLiuQin('丙', originalGongWei) + '：' + diwang + '  ' + '（孟甲）';
            break;
          case '坤':
            result = '丙' + getLiuQin('丙', originalGongWei) + '：' + shuai + '，' + bing + '  ' + '（孟甲）';
            break;
          case '兑':
      ...
      case '丁':
        switch (gongwei) {
          ...
          case '震':
            ...
            break;
          case '巽':
            result = '丁' + getLiuQin('丁', originalGongWei) + '：' + diwang + '，' + shuai + '  ' + '（季甲）';
            break;
          case '离':
            result = '丁' + getLiuQin('丁', originalGongWei) + '：' + linguan + '  ' + '（季甲）';
            break;
          case '坤':
            result = '丁' + getLiuQin('丁', originalGongWei) + '：' + muyu + '，' + guandai + '  ' + '（季甲）';
            break;
          case '兑':
      ...
      case '戊':
        switch (gongwei) {
          ...
          case '坎':
            ...
            break;
          case '艮':
            result = '戊' + getLiuQin('戊', originalGongWei) + '：' + yang + '，' + zhangsheng + '  ' + '（仲甲）';
            break;
          case '震':
            result =
            ...
            break;
          case '巽':
            result = '戊' + getLiuQin('戊', originalGongWei) + '：' + guandai + '，' + linguan + '  ' + '（仲甲）';
            break;
          case '离':
            result = '戊' + getLiuQin('戊', originalGongWei) + '：' + diwang + '  ' + '（仲甲）';
            break;
          case '坤':
            result = '戊' + getLiuQin('戊', originalGongWei) + '：' + shuai + '，' + bing + '  ' + '（仲甲）';
            break;
          case '兑':
      ...
      case '己':
        switch (gongwei) {
          ...
          case '震':
            ...
            break;
          case '巽':
            result = '己' + getLiuQin('己', originalGongWei) + '：' + diwang + '，' + shuai + '  ' + '（季甲）';
            break;
          case '离':
      ...
      case '庚':
        switch (gongwei) {
          case '乾':
            result = '庚' + getLiuQin('庚', originalGongWei) + '：' + shuai + '，' + bing + '  ' + '（孟甲）';
            break;
          case '坎':
          ...
          case '震':
            ...
            break;
          case '巽':
            result = '庚' + getLiuQin('庚', originalGongWei) + '：' + yang + '，' + zhangsheng + '  ' + '（孟甲）';
            break;
          case '离':
            result = '庚' + getLiuQin('庚', originalGongWei) + '：' + muyu + '  ' + '（孟甲）';
            break;
          case '坤':
            result = '庚' + getLiuQin('庚', originalGongWei) + '：' + guandai + '，' + linguan + '  ' + '（孟甲）';
            break;
          case '兑':
      ...
      case '辛':
        switch (gongwei) {
          case '乾':
            result = '辛' + getLiuQin('辛', originalGongWei) + '：' + muyu + '，' + guandai + '  ' + '（仲甲）';
            break;
          case '坎':
          ...
          case '离':
            ...
            break;
          case '坤':
            result = '辛' + getLiuQin('辛', originalGongWei) + '：' + diwang + '，' + shuai + '  ' + '（仲甲）';
            break;
          case '兑':
      ...
      case '壬':
        switch (gongwei) {
          case '乾':
            result = '壬' + getLiuQin('壬', originalGongWei) + '：' + guandai + '，' + linguan + '  ' + '（季甲）';
            break;
          case '坎':
            result = '壬' + getLiuQin('壬', originalGongWei) + '：' + diwang + '  ' + '（季甲）';
            break;
          case '艮':
            result = '壬' + getLiuQin('壬', originalGongWei) + '：' + shuai + '，' + bing + '  ' + '（季甲）';
            break;
          case '震':
          ...
          case '离':
            ...
            break;
          case '坤':
            result = '壬' + getLiuQin('壬', originalGongWei) + '：' + yang + '，' + zhangsheng + '  ' + '（季甲）';
            break;
          case '兑':
      ...
      case '癸':
        switch (gongwei) {
          case '乾':
            result = '癸' + getLiuQin('癸', originalGongWei) + '：' + diwang + '，' + shuai + '  ' + '（孟甲）';
            break;
          case '坎':
            result = '癸' + getLiuQin('癸', originalGongWei) + '：' + linguan + '  ' + '（孟甲）';
            break;
          case '艮':
            result = '癸' + getLiuQin('癸', originalGongWei) + '：' + muyu + '，' + guandai + '  ' + '（孟甲）';
            break;
          case '震':
  ...
  function getJiGe(tianpangan, dipangan, men, shen, gongwei, zhishi) {
    ...
    if (zhishi) {
      switch (dipangan) {
        case '丁':
          result = result + '<span style="color:#0079FE">玉女守门：</span>主宜阴私和合之事，多有阴贵人相助。<br><br>';
          break;
        case '乙':
          result = result + '<span style="color:#0079FE">日照当们：</span>主谋为多有贵人相助，能逢凶化吉。<br><br>';
          break;
        case '丙':
          result = result + '<span style="color:#0079FE">月拱福门：</span>凡事也是有贵人帮助，家中女人胜男人。<br><br>';
          break;
        case '己':
          result =
            result +
          ...
          break;
        case '庚':
          result = result + '<span style="color:#0079FE">太白刑门：</span>凡事多阻碍，必然见纷争。<br><br>';
          break;
        case '辛':
          result = result + '<span style="color:#0079FE">天庭抵户：</span>凡事有艰难，半途之中难以进退。<br><br>';
          break;
        case '壬':
          result = result + '<span style="color:#0079FE">使入天牢：</span>凡事多变动，必然难有成功。<br><br>';
          break;
        case '癸':
          result =
            result +
    ...
    if (shen == '值符') {
      if (tianpangan == '乙') {
        if (dipangan == '己' || dipangan == '辛') {
          result = result + '<span style="color:#0079FE">三奇得使：</span>利于纳婢续弦，以及隐私暧昧等事。<br><br>';
        }
      }
    }
    if (shen == '值符') {
    ...
    if (tianpangan == '己' || tianpangan == '丁' || tianpangan == '癸') {
      if (men == '死门') {
        if (shen == '六合' || shen == '太阴' || shen == '九地') {
          if (gongwei == '艮') {
            result = result + '<span style="color:#0079FE">鬼假：</span>利宰杀掩埋。<br><br>';
          }
        }
      }
    }
    ...
    if (tianpangan == '己' || tianpangan == '丁' || tianpangan == '癸') {
      if (men == '伤门') {
        if (shen == '六合' || shen == '太阴' || shen == '九地') {
          if (gongwei == '巽') {
            result = result + '<span style="color:#0079FE">神假：</span>利于储蓄收纳。<br><br>';
          }
        }
      }
    }
    ...
    if (tianpangan == '丙') {
      if (men == '生门') {
        if (dipangan == '丁' || dipangan == '戊') {
          result = result + '<span style="color:#0079FE">天遁：</span>大利功名，开创，显扬等事。<br><br>';
        }
      }
    }
    // 地遁
    if (tianpangan == '乙') {
      if (men == '开门') {
        if (dipangan == '己') {
          result = result + '<span style="color:#0079FE">地遁：</span>大利收纳，建造，稳固等事。<br><br>';
        }
      }
    }
    // 人遁
    if (tianpangan == '丁') {
      if (men == '休门') {
        if (shen == '太阴') {
          result = result + '<span style="color:#0079FE">人遁：</span>大利财禄，谒贵等事。<br><br>';
        }
      }
    }
    // 神遁
    if (tianpangan == '丙') {
      if (men == '生门') {
        if (shen == '九天') {
          result = result + '<span style="color:#0079FE">神遁：</span>大利功名，开创，显扬等事。<br><br>';
        }
      }
    }
    // 鬼遁
    if (tianpangan == '乙') {
      if (men == '开门') {
        if (shen == '九地') {
          result = result + '<span style="color:#0079FE">鬼遁：</span>大利收纳，建造，稳固等事。<br><br>';
        }
      }
    }
    // 风遁
    ...
    if (tianpangan == '乙') {
      if (men == '休门' || men == '生门' || men == '开门') {
        if (gongwei == '震' || dipangan == '辛') {
          result = result + '<span style="color:#0079FE">云遁：</span>宜伏藏变化，兴云致雾，利于出兵。<br><br>';
        }
      }
    }
    // 龙遁
  ...
  function mengong(men, gong) {
    ...
    switch (men) {
      case '休门':
        switch (gong) {
          case '乾':
            return yi + '<span style="color:#0079FE">休加开：</span>主开张店铺及见贵，求财等事大吉。<br><br><hr><br>';
          case '坎':
            return (
              fuyin +
          ...
          case '艮':
            return (
              shouzhi + '<span style="color:#0079FE">休加生：</span>得阴人财物；于贵谋望，虽迟应吉。<br><br><hr><br>'
            );
          case '震':
            return (
              he +
          ...
          case '离':
            return (
              fanyin + '<span style="color:#0079FE">休加景：</span>主谋望文书印信等事不成，反招口舌。<br><br><hr><br>'
            );
          case '坤':
            return (
              shouzhi +
          ...
          case '兑':
            return he + '<span style="color:#0079FE">休加惊：</span>主损财、招非并疾病惊恐事。<br><br><hr><br>';
          case '中':
      ...
      case '生门':
        switch (gong) {
          ...
          case '震':
            return shouzhi + '<span style="color:#0079FE">生加伤：</span>主亲友变动，道路不吉。<br><br><hr><br>';
          case '巽':
            return shouzhi + '<span style="color:#0079FE">生加杜：</span>主阴谋、阴人损财，不利。<br><br><hr><br>';
          case '离':
            return yi + '<span style="color:#0079FE">生加景：</span>主阴人、小口不宁及文书事。<br><br><hr><br>';
          case '坤':
            return fanyin + '<span style="color:#0079FE">生加死：</span>主田宅官司，病则主难救。<br><br><hr><br>';
          case '兑':
            return he + '<span style="color:#0079FE">生加惊：</span>主尊长财产、词讼，病迟愈，吉。<br><br><hr><br>';
          case '中':
      ...
      case '伤门':
        switch (gong) {
          ...
          case '坎':
            return yi + '<span style="color:#0079FE">伤加休：</span>主男人变动或托人谋事，财名不利。<br><br><hr><br>';
          case '艮':
            return menpo + '<span style="color:#0079FE">伤加生：</span>主房产、种植业等变动。<br><br><hr><br>';
          case '震':
            return fuyin + '<span style="color:#0079FE">伤加伤：</span>主变动、远行皆主折伤。<br><br><hr><br>';
          case '巽':
            return '<span style="color:#0079FE">伤加杜：</span>主变动、失聪、官司、刑狱、百事凶。<br><br><hr><br>';
          case '离':
            return he + '<span style="color:#0079FE">伤加景：</span>主文书、印信、口舌、惹是生非。<br><br><hr><br>';
          case '坤':
            return (
              menpo + '<span style="color:#0079FE">伤加死：</span>主官司、印信凶，出行大忌，占病凶。<br><br><hr><br>'
            );
          case '兑':
            return (
              fanyin + '<span style="color:#0079FE">伤加惊：</span>主亲人疾病、惊忧，谋为不利，凶。<br><br><hr><br>'
            );
          case '中':
      ...
      case '杜门':
        switch (gong) {
          case '乾':
            return (
              fanyin + '<span style="color:#0079FE">杜加开：</span>主见贵人、官长谋事，先破财后吉。<br><br><hr><br>'
            );
          case '坎':
            return yi + '<span style="color:#0079FE">杜加休：</span>主求财小益。<br><br><hr><br>';
          case '艮':
            return menpo + '<span style="color:#0079FE">杜加生：</span>主阳人小口破财，田宅求财不利。<br><br><hr><br>';
          case '震':
            return '<span style="color:#0079FE">杜加伤：</span>主兄弟田产破财。<br><br><hr><br>';
          case '巽':
            return fuyin + '<span style="color:#0079FE">杜加杜：</span>主因父母疾病、田宅出脱事，凶。<br><br><hr><br>';
          case '离':
            return he + '<span style="color:#0079FE">杜加景：</span>主文书、印信阻隔，阳人小口疾病。<br><br><hr><br>';
          case '坤':
            return (
              menpo + '<span style="color:#0079FE">杜加死：</span>主田宅、文书失落，官司破财小凶。<br><br><hr><br>'
            );
          case '兑':
            return shouzhi + '<span style="color:#0079FE">杜加惊：</span>主门户内忧疑、惊恐、词讼事。<br><br><hr><br>';
          case '中':
            return menpo + '<br><hr><br>';
        }
        break;
      case '景门':
        switch (gong) {
          case '乾':
            return menpo + '<span style="color:#0079FE">景加开：</span>官人升迁，求文印事皆吉。<br><br><hr><br>';
          case '坎':
            return fanyin + '<span style="color:#0079FE">景加休：</span>主文书遗失，争讼不休。<br><br><hr><br>';
          case '艮':
            return (
              he + '<span style="color:#0079FE">景加生：</span>主阴人生产大喜，更主求财旺利，行人大吉。<br><br><hr><br>'
            );
          case '震':
          ...
          case '坤':
            return he + '<span style="color:#0079FE">景加死：</span>主官讼，争田宅事，多啾唧。<br><br><hr><br>';
          case '兑':
            return menpo + '<span style="color:#0079FE">景加惊：</span>主官讼，女人小口疾病，凶。<br><br><hr><br>';
          case '中':
            return he + '<br><hr><br>';
        }
        break;
      case '死门':
        switch (gong) {
          case '乾':
            return he + '<span style="color:#0079FE">死加开：</span>见贵人求文书、印信事利。<br><br><hr><br>';
          case '坎':
            return menpo + '<span style="color:#0079FE">死加休：</span>主求财物事不吉，向僧道求方吉。<br><br><hr><br>';
          case '艮':
            return (
              fanyin + '<span style="color:#0079FE">死加生：</span>主丧事，求财则得，占病死者复生。<br><br><hr><br>'
            );
          case '震':
            return shouzhi + '<span style="color:#0079FE">死加伤：</span>官司变动遭刑杖凶。<br><br><hr><br>';
          case '巽':
            return shouzhi + '<span style="color:#0079FE">死加杜：</span>破财，妇人风疾，腹肿。<br><br><hr><br>';
          case '离':
            return (
              yi + '<span style="color:#0079FE">死加景：</span>因文信、书契、财产事见官，先怒后喜不凶。<br><br><hr><br>'
            );
          case '坤':
            return fuyin + '<span style="color:#0079FE">死加死：</span>主官事，无气、凶。<br><br><hr><br>';
          case '兑':
            return he + '<span style="color:#0079FE">死加惊：</span>因官司事不结，忧疑患病凶。<br><br><hr><br>';
          case '中':
            return fanyin + '<br><hr><br>';
        }
        break;
      case '惊门':
        switch (gong) {
          ...
          case '艮':
            return yi + '<span style="color:#0079FE">惊加生：</span>主因妇人生产或求财而生惊忧，皆吉。<br><br><hr><br>';
          case '震':
            return fanyin + '<span style="color:#0079FE">惊加伤：</span>主因商议同谋害人事泄，惹讼凶。<br><br><hr><br>';
          case '巽':
            return menpo + '<span style="color:#0079FE">惊加杜：</span>失脱破财事，惊恐，不凶。<br><br><hr><br>';
          case '离':
            return shouzhi + '<span style="color:#0079FE">惊加景：</span>主讼词不息，小口疾病，凶。<br><br><hr><br>';
          case '坤':
            return yi + '<span style="color:#0079FE">惊加死：</span>因田宅中怪异而生是非，凶。<br><br><hr><br>';
          case '兑':
            return fuyin + '<span style="color:#0079FE">惊加惊：</span>主疾病、忧虑、惊疑、惊恐。<br><br><hr><br>';
          case '中':
            return yi + '<br><hr><br>';
        }
        break;
      case '开门':
        switch (gong) {
          case '乾':
            return (
              fuyin + '<span style="color:#0079FE">开加开：</span>主贵人、宝物、财喜、官运、事业皆吉。<br><br><hr><br>'
            );
          case '坎':
            return (
              he + '<span style="color:#0079FE">开加休：</span>主见贵人、财喜、开张店铺、贸易大利。<br><br><hr><br>'
            );
          case '艮':
            return yi + '<span style="color:#0079FE">开加生；</span>见贵人，谋望所求遂意。<br><br><hr><br>';
          case '震':
            return (
              menpo + '<span style="color:#0079FE">开加伤：</span>主变动、更改、移徙等事，皆不吉。<br><br><hr><br>'
            );
          case '巽':
            return fanyin + '<span style="color:#0079FE">开加杜：</span>主失脱文印、书契等，小凶。<br><br><hr><br>';
          case '离':
            return shouzhi + '<span style="color:#0079FE">开加景：</span>见贵人，因文书事不利。<br><br><hr><br>';
          case '坤':
            return yi + '<span style="color:#0079FE">开加死：</span>官司、惊忧、恶事，先忧后喜。<br><br><hr><br>';
          case '兑':
  ...
  function createGongweiOverlayListener(overlay, index) {
    return function handleClick() {
      ...
      const tianpanshenValue = document.querySelectorAll('[data-tianpanshen]')[index].innerText;
